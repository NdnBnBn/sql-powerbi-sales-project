...
L’objectif est de produire des **insights actionnables** pour la prise de décision : segmentation clients, suivi des KPIs et identification des produits les plus performants.

---

## Objectifs
- Nettoyer et transformer les données avec SQL  
- Calculer des KPI clés : chiffre d’affaires, panier moyen, nombre de clients  
- Segmenter les clients avec **RFM (Recency, Frequency, Monetary)**  
...
- **Scatter plot RFM :** Recency vs Frequency par client, taille = Monetary  
...
4. Les clients les plus fidèles identifiés grâce au scatter plot RFM  
5. Chiffre d’affaires mensuel en croissance  

---

## Outils
- **SQL / SQLite (DB Browser for SQLite)** : nettoyage, KPIs, RFM  
- **Power BI Web** : visualisation interactive et dashboards  
- **GitHub** : partage du projet et documentation  

---

## Fichiers inclus
- `SQL_queries.sql` : toutes les requêtes SQL utilisées pour nettoyage, KPIs et RFM  
...
💡 Ce projet montre la **maîtrise complète du cycle de l’analyse de données**, de la préparation SQL à la visualisation interactive, avec un accent sur les insights actionnables et la segmentation clients.
